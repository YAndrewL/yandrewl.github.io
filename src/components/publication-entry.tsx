            ...
            <div className="flex flex-col flex-1">
                <div className="flex flex-row gap-4 items-center mb-2">
                    ...
                    {publication.preprint && (
                        <div className="group flex px-2 py-1 bg-gradient-to-r from-blue-50 to-green-50 rounded-md items-center shadow-md border border-blue-100/50 relative overflow-hidden hover:rotate-1 transition-all duration-300">
                            <div className="absolute inset-0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/90 to-transparent" />
                            <p className="text-xs text-blue-700 font-medium relative">
                                {publication.preprint}
                            </p>
                        </div>
                    )}
                ...
                <div className="flex flex-row gap-6">
                    {publication.paperUrl && (
                        <a
                            ...
                            className="group inline-flex items-center gap-2 text-xs hover:text-zinc-900 transition-colors duration-300"
                            style={{ color: '#E36C2D' }}
                        >
                            <ArrowUpRight
                                size={12}
